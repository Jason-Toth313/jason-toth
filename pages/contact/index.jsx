        ...
        <div className="flex flex-col items-center xl:items-start mb-12 xl:mb-0 xl:mr-16">
          ...
          <ul className="space-y-4 text-center xl:text-left">
            <li className="flex items-center gap-2">
              ...
              <a
                href="mailto:toth.jason.dev@gmail.com"
                className="text-accent"
              >
                toth.jason.dev@gmail.com
              </a>
            </li>
            <li className="flex items-center gap-2">
              <BsTelephoneFill className="text-accent text-xl" />
              <span className="font-semibold">Phone:</span>
              <a href="tel:+15124340970" className="text-accent">
                +1 (512) 434-0970
              </a>
            </li>
            {/* <li className="flex items-center gap-2">
          ...
          <div className="flex space-x-4 mt-6">
            <a
              href="https://github.com/Jason-Toth313"
              className="text-accent"
            >
              <FaGithub className="text-2xl" />
            </a>
            <a href="https://www.linkedin.com/in/jason-t-025392390" className="text-accent">
